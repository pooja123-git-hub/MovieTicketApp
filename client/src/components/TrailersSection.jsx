...
const TrailersSection = () => {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
      <p className='text-gray-300 font-meduim text-lg max-w-[960px] mx-auto'
      >Trailers</p>
...
{dummyTrailers.map((trailer)=>(
  ...
  onClick={()=>setCurrentTrailer(trailer)}>
    ...
    <PlayCircleIcon strokeWidth={1.6} className='absoulte top-1/2 left-1/2 w-5 md:w-8 h-5 md:h-12 transform -translate-x-1/2'/>
</div>
))}
