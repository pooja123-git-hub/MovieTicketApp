...
<p>
  {timeFormat(show.movie.runtime)}.{show.movie.genres.map(genres=>
    genres.name).join(", ")}{show.movie.release_date.split(" ")[0]}
        ...
        <a href='#dateSelect' className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointwe active:scale-95'>Buy Tickets</a>
