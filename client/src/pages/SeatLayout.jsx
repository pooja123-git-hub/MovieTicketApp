...
// </div>
//         </div>
// <button onClick={bookTicket} className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer active:scale-95'>Proceed to Checkout
...
const SeatLayout = () => {
  ...
  console.log("Selected Seats", selectedSeats);
      ...
      if (data.success) {
        const options = {
          key: import.meta.env.VITE_RAZORPAY_KEY_ID, // Make sure to store this in .env
          amount: data.order.amount,
          currency: data.order.currency,
          name: "Aza Movie Booking",
